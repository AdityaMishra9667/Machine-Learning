# -*- coding: utf-8 -*-
"""
Created on Sat Aug 28 16:56:18 2021
...
cross_val_score(lm, X_train, y_train, scoring = 'neg_mean_absolute_error', cv= 4)
...
"""takes all models and spits out the one with the best results"""
...
gs.best_score_ #gives the best score among the various models
gs.best_estimator_ #shows the detail of the best model
